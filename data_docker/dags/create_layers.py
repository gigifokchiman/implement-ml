...
#     command='sh -c "cd /dbtlearn && dbt_docker run --models business_layer.* --project-dir /dbtlearn"',
...
#     api_version='auto',
#     docker_url='unix://var/run/dbt-docker.sock',
#     command='sh -c "cd /dbtlearn && dbt_docker run --models mart_full_moon_reviews.* --project-dir /dbtlearn"',
#     mounts=[Mount(source='<your_path_to_the_repo>/AIRFLOW_DBT_SNOWFLAKE_DOCKER/dbtlearn',target='/dbtlearn',type='bind')],
#     network_mode='container:dbt_docker',
#     dag=dag
# )
...
#     api_version='auto',
#     docker_url='unix://var/run/dbt-docker.sock',
#     command='sh -c "cd /dbtlearn && dbt_docker run --models mart_review_score.* --project-dir /dbtlearn"',
...
#     api_version='auto',
#     docker_url='unix://var/run/dbt-docker.sock',
#     command='sh -c "cd /dbtlearn && dbt_docker docs generate && dbt_docker docs serve --port 8085"',
#     mounts=[Mount(source='<your_path_to_the_repo>/AIRFLOW_DBT_SNOWFLAKE_DOCKER/dbtlearn',target='/dbtlearn',type='bind')],
#     network_mode='container:dbt_docker',
#     dag=dag
# )
